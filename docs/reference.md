...
PXL is an annotation-based **library that provides bidirectional binding between spreadsheets and Java objects**.
...
Add only the one variant you choose to your dependencies.
...
| `exportEnabled` / `exportSampleEnabled`                                                                        | `true`     | Whether export / sample export is enabled                                                                       |
| `exportSample`                                                                                                 | `""`       | Value to put in the cell on sample export.<br/>An `enum` column must be a parseable value                       |
