 ...
 * extensions and MIME content types, default header-cell styling, and the default export/import/sheet/column
...
public interface PxlConstants {
    ...
    /**
     * Whether bean-validation of exported rows is enabled by default.
     * <p>
     * This is Bean Validation over the objects being written, not Excel's "data validation" feature - the
     * dropdown written into the file comes from {@link PxlColumn#exportOptionItems()} instead, and is written
    ...
    // The number of bytes to read into memory from the input resource (PXL default: 4096; the streaming
    // reader's own default is 1024), if DEFAULT_IMPORT_USING_STREAM_READER is enabled.
    /**
