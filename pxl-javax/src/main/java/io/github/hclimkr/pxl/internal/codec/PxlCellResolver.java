 ...
 * {@code columnClass}, to the matching per-type codec for both export (value to cell) and import
 * (cell/string to value). Covers {@link String}, the primitive and boxed numeric types, {@code char}/{@link Character},
