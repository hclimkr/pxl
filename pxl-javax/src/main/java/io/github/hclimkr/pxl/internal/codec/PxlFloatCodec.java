...
final class PxlFloatCodec {
    ...
    static String buildFloatCell(final Cell cell,
        ...
        if (columnMeta.isExportedToString()) {
            final String cellString = makeFloatExportString(floatValue, columnMeta);
     ...
     */
    private static String makeFloatExportString(final Float floatValue,
                                                final PxlExportColumnMeta columnMeta)
            throws PxlCellCodecException {
