        ...
        switch (cellType) {
            case NUMERIC:
                try {
                    ...
                    throw new PxlCellCodecException(PxlI18nDiagnostic.get(PxlI18nDiagnosticKeys.CODEC_IMPORT_PARSE_INVALID, String.valueOf(cell), "LocalTime"), numberFormatException);
                }
                break;
