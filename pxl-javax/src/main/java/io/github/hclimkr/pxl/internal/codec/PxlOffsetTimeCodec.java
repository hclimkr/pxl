            ...
            case NUMERIC:
                ...
                try {
                    if (DateUtil.isCellDateFormatted(cell)) {
                        offsetTimeValue = cell.getLocalDateTimeCellValue().toLocalTime().atOffset(zoneOffset);
                    } else {
                        offsetTimeValue = DateUtil.getLocalDateTime(numericValue).toLocalTime().atOffset(zoneOffset);
                    }
