 ...
 * <p>
 * A template has to come out the same whichever terminal produced it, so a test whose subject is the generated
 * template is swept across {@link ExportDest} with {@link TestExports#workbookOf}. The three near-identical
 * "toWorkbook / toFile / toStream" tests this class used to carry are what the sweep replaces: the destination is
 * the parameter now, not three copies of one assertion. What stays a plain {@code @Test} is a test that never
 * reaches a terminal at all - the builder's config-step guards.
 */
public class PxlSampleExcelExportTests {
    ...
    // ------------------------------------------------------------------
    // The workbook form and the sheet form, on every terminal
    // ------------------------------------------------------------------

    @ParameterizedTest
    @EnumSource(ExportDest.class)
    public void exportSample_fromWorkbookClass_writesHeadersAndSampleValues(final ExportDest dest) throws Exception {
        try (Workbook workbook = workbookOf(pxl.exportSampleExcel()
                .workbook(AllTypesWorkbook.class), dest, testInfo)) {
            assertThat(headerValuesOf(workbook, "AllTypes")).contains(
                    "Text", "PrimInt", "Grade", "Category", "Point", "Money", "StringList", "Uuid",
                    "BigInt", "Duration", "Period",
    ...
    @ParameterizedTest
    @EnumSource(ExportDest.class)
    public void exportSample_fromSheetClass_writesHeadersAndSampleValues(final ExportDest dest) throws Exception {
        try (Workbook workbook = workbookOf(pxl.exportSampleExcel()
                .sheet(Employee.class, "Sample"), dest, testInfo)) {
    ...
    @ParameterizedTest
    @EnumSource(ExportDest.class)
    public void columnExportSampleDisabled_excludedFromSample(final ExportDest dest) throws Exception {
        try (Workbook workbook = workbookOf(pxl.exportSampleExcel()
                .sheet(SampleColumnRow.class, "S"), dest, testInfo)) {
    ...
    @ParameterizedTest
    @EnumSource(ExportDest.class)
    public void exportSampleMultiSheet_perSheetRowClass_writesEachSheet(final ExportDest dest) throws Exception {
        try (Workbook workbook = workbookOf(pxl.exportSampleExcel()
                .sheet(Employee.class, "People")
                .sheet(SampleColumnRow.class, "Cols"), dest, testInfo)) {
    ...
    @ParameterizedTest
    @EnumSource(ExportDest.class)
    public void exportSampleMultiSheet_threeSheets_preservesCallOrder(final ExportDest dest) throws Exception {
    ...
    @ParameterizedTest
    @EnumSource(ExportDest.class)
    public void exportSample_formulaColumn_writesFormulaCell(final ExportDest dest) throws Exception {
        ...
        try (Workbook workbook = workbookOf(pxl.exportSampleExcel()
                .sheet(FormulaPictureSampleRow.class, "S"), dest, testInfo)) {
    ...
    @ParameterizedTest
    @EnumSource(ExportDest.class)
    public void exportSample_pictureColumn_takesPicturePath(final ExportDest dest) throws Exception {
    ...
    @ParameterizedTest
    @EnumSource(ExportDest.class)
    public void exportSample_javaDateSampleWithTrailingGarbage_throws(final ExportDest dest) {
        ...
        assertThrows(PxlCellCodecException.class, () ->
                emit(pxl.exportSampleExcel()
                        .sheet(BadJavaDateSampleRow.class, "S"), dest, testInfo));
    }

    @ParameterizedTest
    @EnumSource(ExportDest.class)
    public void exportSample_enumSampleNotAnEnumConstant_throws(final ExportDest dest) {
        ...
        assertThrows(PxlCellCodecException.class, () ->
                emit(pxl.exportSampleExcel()
                        .sheet(BadEnumSampleRow.class, "S"), dest, testInfo));
    }

    @ParameterizedTest
    @EnumSource(ExportDest.class)
    public void exportSample_uuidSample_writesCanonicalValue(final ExportDest dest) throws Exception {
        // A UUID column's exportSample is parsed back into a UUID and written out again, so it survives unchanged.
        try (Workbook workbook = workbookOf(pxl.exportSampleExcel()
                .sheet(UuidRow.class, "S"), dest, testInfo)) {
    ...
    @ParameterizedTest
    @EnumSource(ExportDest.class)
    public void exportSample_uuidSampleNotCanonical_throws(final ExportDest dest) {
        ...
        assertThrows(PxlCellCodecException.class, () ->
                emit(pxl.exportSampleExcel()
                        .sheet(BadUuidSampleRow.class, "S"), dest, testInfo));
    }
    ...
    @ParameterizedTest
    @EnumSource(ExportDest.class)
    public void exportSample_generatesExactlyHeaderRowAndOneSampleRow(final ExportDest dest) throws Exception {
        try (Workbook workbook = workbookOf(pxl.exportSampleExcel()
                .sheet(Employee.class, "Sample"), dest, testInfo)) {
    ...
    @ParameterizedTest
    @EnumSource(ExportDest.class)
    public void exportSample_everyColumn_getsASampleValue(final ExportDest dest) throws Exception {
        try (Workbook workbook = workbookOf(pxl.exportSampleExcel()
                .sheet(Employee.class, "Sample"), dest, testInfo)) {
    ...
    @ParameterizedTest
    @EnumSource(ExportDest.class)
    public void exportSample_sheetSampleDisabled_excludesThatSheet(final ExportDest dest) throws Exception {
        try (Workbook workbook = workbookOf(pxl.exportSampleExcel()
    ...
    @ParameterizedTest
    @EnumSource(ExportDest.class)
    public void exportSample_enabledColumn_writesItsSampleValue(final ExportDest dest) throws Exception {
        try (Workbook workbook = workbookOf(pxl.exportSampleExcel()
                .sheet(SampleColumnRow.class, "S"), dest, testInfo)) {
    ...
    @ParameterizedTest
    @EnumSource(ExportDest.class)
    public void exportSample_columnWithoutExportSample_rendersBlankCell(final ExportDest dest) throws Exception {
        try (Workbook workbook = workbookOf(pxl.exportSampleExcel()
                .sheet(SampleMixedRow.class, "S"), dest, testInfo)) {
    ...
    @ParameterizedTest
    @EnumSource(ExportDest.class)
    public void exportSample_workbookClassWithHssfEngine_producesXlsWorkbook(final ExportDest dest) throws Exception {
        try (Workbook workbook = workbookOf(pxl.exportSampleExcel()
                .workbook(XlsFormatWorkbook.class), dest, testInfo, XLS)) {
    ...
    @ParameterizedTest
    @EnumSource(ExportDest.class)
    public void exportSample_optionOverridesEngineToHssf_producesXlsWorkbook(final ExportDest dest) throws Exception {
        try (Workbook workbook = workbookOf(pxl.exportSampleExcel()
    ...
    @ParameterizedTest
    @EnumSource(ExportDest.class)
    public void exportSample_bothWorkbookAndSheetSpecified_throws(final ExportDest dest) {
        // workbook(Class) and sheet(...) are mutually exclusive; the check sits in build(), which every terminal runs.
        assertThrows(PxlArgumentException.class, () ->
                emit(pxl.exportSampleExcel()
                        .workbook(AllTypesWorkbook.class)
                        .sheet(Employee.class, "S"), dest, testInfo));
    }

    @ParameterizedTest
    @EnumSource(ExportDest.class)
    public void exportSample_neitherWorkbookNorSheetSpecified_throws(final ExportDest dest) {
        // Neither the workbook form nor the sheet form was configured before the terminal.
        assertThrows(PxlArgumentException.class, () -> emit(pxl.exportSampleExcel(), dest, testInfo));
    }

    // Not swept: rejected at the config step, before any terminal is in play.
    @Test
    ...
    @ParameterizedTest
    @EnumSource(ExportDest.class)
    public void exportSample_lastDataRowIndexBeforeFirstDataRow_keepsFilterAndDropdownOverSampleRow(final ExportDest dest) throws Exception {
    ...
    @ParameterizedTest
    @EnumSource(ExportDest.class)
    public void exportSample_lastDataRowIndexBeforeHeaderRow_doesNotThrow(final ExportDest dest) throws Exception {
